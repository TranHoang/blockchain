# This code is referenced from stackoverflow.
#!/usr/bin/env python
...
bitcoin_address = base58.b58encode(bytes(bytearray.fromhex(key_hash + checksum)))

print('checksum = %s' % sha.hexdigest())
print('key_hash + checksum = %s' % key_hash + ' ' + checksum )
print('bitcoin address = %s' % str(bitcoin_address, 'utf8'))